...
local core_map = {
	...
	["n|<leader>os"] = map_cr("setlocal spell! spelllang=en_us"):with_desc("Edit: Toggle Spell Check"),
	["n|<leader>bn"] = map_cr("tabnew"):with_noremap():with_silent():with_desc("Tab: Create a New Tab"),
	["n|<leader>bk"] = map_cr("tabnext"):with_noremap():with_silent():with_desc("Tab: Move to Next Tab"),
	["n|<leader>bj"] = map_cr("tabprevious"):with_noremap():with_silent():with_desc("Tab: Move to Previous Tab"),
	["n|<leader>bo"] = map_cr("tabonly"):with_noremap():with_silent():with_desc("Tab: Only Keep Current Tab"),
	-- Insert mode
